...
$update =$connection->query("UPDATE class SET className ='$className',teacherID ='$teacherID' WHERE classID = '$classID'");
...
if (isset($_GET['classID'])) {
  $classID = $_GET['classID'];
$select = $connection->query("SELECT * FROM class WHERE classID= $classID");
...
<div>
    <form method="POST" action="">
        <h3>class Update Form </h3>
        <br>
    <input type="hidden" name="classID" value="<?php echo $row['classID']; ?>" style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solclassID #ccc;
      border-radius: 5px;
      box-sizing: border-box;">
    <br>
    
    <input type="text" class="f " name="className" value="<?php echo $row['className']; ?>"style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solclassID #ccc;
      border-radius: 5px;
      box-sizing: border-box;">
    <br>
    <input type="text" class="f " name="teacherID" value="<?php echo $row['teacherID']; ?>" style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solclassID #ccc;
      border-radius: 5px;
    ...
    <input type="submit" name="submit" value="Update" style=" wclassIDth: 10%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solclassID #ccc;
      border-radius: 5px;
