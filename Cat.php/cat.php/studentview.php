...
if ($result->num_rows > 0) {
    ...
    echo "<tr style='background-color:lightseagreen; color:white;'>";
        echo"<td colspan='6'><center> <a href='student.php'>ADD NEW STUDENT </a></center></td>";
    echo "<tr bgcolor='skybule'><th>studentID</th><th>First Name</th><th>Last Name</th><th>Date Of Birth</th><th>Teacher ID</th><th>action</th></tr>";
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row['teacherID'] . "</td>";
         echo "<td> <a href='supdate.php?studentID=".$row["studentID"]."'> Update</a>&nbsp;&nbsp;&nbsp;<a href='sdelete.php?studentID=".$row["studentID"]."'><font color='red'>Delete</font></a></td>";
        echo "</tr>";
