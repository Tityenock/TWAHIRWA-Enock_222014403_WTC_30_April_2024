...
if ($result->num_rows > 0) {
    echo "<center><table border='1' width='1000'>";
     echo "<tr style='background-color:lightseagreen;color:white;'>";
        echo"<td colspan='5'><center><a href='register.html'>ADD NEW user ON LIST</a></center></td>";
    echo "<tr bgcolor='skybule'><th> ID</th><th>USERNAME</th><th>Password</th><th>ROLE</th><th>action</th></tr>";
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row['role'] . "</td>";
         echo "<td> <a href='rupdate.php?Id=".$row["Id"]."'>update</a>&nbsp;&nbsp;&nbsp;<a href='rdelete.php?Id=".$row["Id"]."'>delete</a></td>";
        echo "</tr>";
