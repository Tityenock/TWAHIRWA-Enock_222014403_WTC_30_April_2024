...
$update =$connection->query("UPDATE users SET username ='$username',password ='$password',role ='$role' WHERE Id = '$id'");
...
<div>
    <form method="POST" action="">
        ...
        <br>
    <input type="hidden" name="Id" value="<?php echo $row['Id']; ?>" style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
    ...
    <input type="text" class="f " name="username" value="<?php echo $row['username']; ?>"style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solid #ccc;
      border-radius: 5px;
      box-sizing: border-box;">
    <br>
    <input type="text" class="f " name="password" value="<?php echo $row['password']; ?>" style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solid #ccc;
      border-radius: 5px;
      box-sizing: border-box;">
    <br>
    <input type="text" class="f " name="role" value="<?php echo $row['role']; ?>" style=" width: 40%;
      padding: 10px;
      margin-bottom: 10px;
      border: 1px solid #ccc;
      border-radius: 5px;
